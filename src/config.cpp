...
void Config::set(std::string identifier, bool value) {
	set(identifier, Value(value));
}

void Config::set(std::string identifier, double value) {
	set(identifier, Value(value));
}

void Config::set(std::string identifier, int value) {
	set(identifier, Value(value));
}

void Config::set(std::string identifier, std::string value) {
	set(identifier, Value(value));
}
...
bool Config::get_bool(std::string identifier) {
	try {
		...
		throw Value_Not_Found(identifier);
	}
}
...
File_Not_Found::File_Not_Found()
    : std::runtime_error("Config file not found") {}

Value_Not_Found::Value_Not_Found(std::string key)
